...
public final class FindMeetingQuery {
  ...
  public Collection<TimeRange> query(Collection<Event> events, MeetingRequest request) {
    ...
    //Step One: go through each event, find out which events request participants are in, get timerange
    ...
    //If the resulting array is empty, repeat without optional attendees
    if(ranges.isEmpty()){
      conflictingEventTimes = new ArrayList<>();
      for(Event event: events) {
