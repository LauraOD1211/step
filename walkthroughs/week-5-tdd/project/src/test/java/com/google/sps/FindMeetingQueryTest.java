...
public final class FindMeetingQueryTest {
  ...
  public void optionalAttendeesIgnored() {
    // Add an optional attendee that is busy all day. The timetable should be
    // the same as if the optional attendee wasn't invited.
    //
    // Events  :       |--A--|     |--B--|
    //         : |--------------C--------------|           
    // Day     : |-----------------------------|
  ...
  public void optionalAttendeesConsidered() {
    // Add an optional attendee that has one event. The timetable should take
    // the optional attendee's event into account.
    //
    // Events  :       |--A--|--C--|--B--|          
    // Day     : |-----------------------------|
    // Options : |--1--|                 |--3--|
  ...
  public void notEnoughRoomForOptional() {
    // Have one mandatory person, but make it so that there is just enough room
    // at one point in the day to have the meeting. Add an optional person in the
    // middle of the only free slot, they should be ignored
    //
    // Events  : |--A--|     |----A----|
    //         :       |-B-|
    // Day     : |---------------------|
  ...
  public void onlyOptionalAttendees() {
    // Have each person be optional and have different events. We should see 
    // two options because each person has split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
  ...
  @Test
  public void optionalNoFreeSpace() {
    // Have each person be optional and have full schedules. The whole day
    // should be returned as there is no suitable time for everyone.
    //
    // Events  : |--------A--------|
    //         :             |--------B--------|
    // Day     : |-----------------------------|
